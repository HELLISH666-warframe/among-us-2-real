...
function postCreate() {
    ...
    exploders.alpha = 0.01;
		...
		wasted = new FlxTypedGroup();
		blood = new FlxTypedGroup();
	sky3.visible =  city3.visible = mountains3.visible =  hellbg.visible =  firebg.visible = satan.visible =  street3.visible =  bloodshed_lamp.visible = firetrojan_staticbg.visible = islands.visible = false;
	...
	if (curStep == 152)
{
    ...
    rain.data.opacity.value = [0.25];
		...
		{
			sky2.visible =  city2.visible = mountains2.visible =  hillfront2.visible =  fog2.visible = street2.visible = false;
			sky3.visible =  city3.visible = mountains3.visible =  hellbg.visible =  firebg.visible = satan.visible =  street3.visible = true;
			add(Estatic);
			Estatic.alpha = 1;
